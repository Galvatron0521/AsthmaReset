...
public class AlarmService extends Service {
    ...
    public static final String ALARM_SERVICE_ACTION = "com.shenkangyun.asthmaproject.Service.AlarmService";
    ...
    private void setNextAlarm() {
        ...
        intent.setAction("com.shenkangyun.asthmaproject.Service.AlarmService");
        intent.putExtra("uuid", Integer.parseInt(clockModel.getUuid()));
        PendingIntent pendingIntent;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            pendingIntent = PendingIntent.getForegroundService(this,
